...
import com.bll.lnkwrite.dialog.CalendarDiaryDialog
import com.bll.lnkwrite.dialog.CatalogDiaryDialog
...
class DiaryActivity:BaseDrawingActivity() {
    ...
    override fun initView() {
        ...
        iv_btn.setOnClickListener {
            ModuleItemDialog(this,getCurrentScreenPos(),getString(R.string.module_diary_str), DataBeanManager.diaryModules).builder()
        ...
        tv_digest.setOnClickListener {
            InputContentDialog(this,getCurrentScreenPos(),if (diaryBean?.title.isNullOrEmpty()) getString(R.string.input_diary_digest_hint) else diaryBean?.title!!).builder().setOnDialogClickListener{
                diaryBean?.title=it
                saveDiary()
            }
        }
