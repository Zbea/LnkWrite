...
class HomeworkResultStandardAdapter(layoutResId: Int,val correctModule:Int, data: List<ResultStandardItem>?) : BaseQuickAdapter<ResultStandardItem, BaseViewHolder>(layoutResId, data) {
    ...
    class ChildAdapter(layoutResId: Int, val correctModule:Int, private val isVertical:Boolean, data: List<ResultStandardItem.ResultChildItem>?) : BaseQuickAdapter<ResultStandardItem.ResultChildItem, BaseViewHolder>(layoutResId, data) {
